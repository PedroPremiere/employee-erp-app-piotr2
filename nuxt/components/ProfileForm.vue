                ...
                <v-row class="mt-1">
                    <v-col cols="6">
                        <v-text-field
                            ...
                            prepend-icon="mdi-face-profile-woman"
...
import profileValidatorMixin from '@/validators/profile.mixin';

export default {
    name: 'UserForm',
    mixins: [validationMixin, profileValidatorMixin],
    props: {
